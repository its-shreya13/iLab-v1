          ...
          <div className="max-w-xl lg:max-w-3xl">
            <div className="relative -mt-16 block lg:hidden">
              ...
              <p className="mt-4 leading-relaxed text-gray-500 dark:text-gray-400">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Temporibus saepe culpa enim atque, pariatur et aspernatur expedita cumque. Facere quis voluptates tempora consequatur deleniti dicta aut? Quis numquam non deserunt.
              </p>
            </div>
            <SignIn />
          </div>
